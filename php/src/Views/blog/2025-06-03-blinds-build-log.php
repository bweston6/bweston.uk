...
<?= image("/assets/breadboard.jpg", "Breadboard with a barrel jack connected to the power rails on flying leads. From left to right there's a Raspberry Pi Pico W, A4988 stepper motor driver and L78 series linear regulator."); ?>
...
supply.</p>
<?= image("/assets/nema-17.jpg", "Nema 17 stepper motor", "width-50"); ?>
...
<?= image("/assets/esphome.jpg", "ESPhome online configuration editor showing the start of the blinds configuration."); ?>
...
<?= image("/assets/home-assistant-slider.jpg", "Exact positioning slider from the Home Assistant web interface.", "width-50"); ?>

<?= image("/assets/home-assistant-buttons.jpg", "Up, down, and stop buttons for blinds in the Home Assistant web interface.", "width-50"); ?>
...
of my issues.</p>
<?= image("/assets/gearbox-side.jpg", "Printed gearbox attached to the NEMA 17 stepper motor."); ?>

<?= image("/assets/gearbox-top.jpg", "View from the top showing the gear meshing with the blind's bead chain."); ?>
...
strips.</p>
<?= image("/assets/strip-board-front.jpg", "The front of the strip board"); ?>

<?= image("/assets/strip-board-back.jpg", "The back of the strip board"); ?>
...
Fusion.</p>
<?= image("/assets/rodret.jpg", "A render of the custom button faceplate with options for opening blinds at the top, closing on the bottom left and stopping on the bottom right."); ?>
