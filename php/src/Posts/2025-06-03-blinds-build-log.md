...
## The Mock-up
### Electronics
![Breadboard with a barrel jack connected to the power rails on flying leads. From left to right there's a Raspberry Pi Pico W, A4988 stepper motor driver and L78 series linear regulator.](/assets/breadboard.jpg)
...
![Nema 17 stepper motor](/assets/nema-17.jpg)
...
![ESPhome online configuration editor showing the start of the blinds configuration.](/assets/esphome.jpg)
...
![Exact positioning slider from the Home Assistant web interface.](/assets/home-assistant-slider.jpg)

![Up, down, and stop buttons for blinds in the Home Assistant web interface.](/assets/home-assistant-buttons.jpg)
...
![Printed gearbox attached to the NEMA 17 stepper motor.](/assets/gearbox-side.jpg)

![View from the top showing the gear meshing with the blind's bead chain.](/assets/gearbox-top.jpg)
...
![Circuit board schematic.](/assets/blinds-schematic.svg)
...
![The front of the strip board](/assets/strip-board-front.jpg)

![The back of the strip board](/assets/strip-board-back.jpg)
...
![A render of the custom button faceplate with options for opening blinds at the top, closing on the bottom left and stopping on the bottom right.](/assets/rodret.jpg)
